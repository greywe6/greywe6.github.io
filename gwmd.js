		...
		last_view: function (data) {
			...
			if (viewed) {
				...
				if ($('body').find('.full-start__buttons,.full-start-new__buttons').length) {
					...
					$('body').find('.full-start__poster,.full-start-new__poster').append("<div class='card--last_view' style='top:0.6em;right: -.5em;position: absolute;background: #168FDF;color: #fff;padding: 0.3em 0.4em 0.4em;font-size: 1.2em;-webkit-border-radius: 0.3em;-moz-border-radius: 0.3em;border-radius: 0.3em;'><div style='float:left;width:10px;hight:10px;margin:-4px 0 -4px -4px' class='card__icon icon--history'></div>" + last_view +"</div>");
