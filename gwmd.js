		...
		last_view: function (data) {
			...
			if (viewed) {
				...
				if ($('body').find('.full-start__buttons,.full-start-new__buttons').length) {
					...
					$('body').find('.full-start__poster,.full-start-new__poster').append("<div class='card--last_view' style='top:0.8em;right: -.5em;position: absolute;background: #1b7db9;color: #fff;padding: 0.3em 0.4em;font-size: 1.3em;-webkit-border-radius: 0.6em;-moz-border-radius: 0.6em;border-radius: 0.6em;'><div style='float:left;margin:-9px 0 -9 -4px' class='card__icon icon--history'></div>" + last_view +"</div>");
