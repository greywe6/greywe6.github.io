...
(function () {
	...
	Lampa.Listener.follow('app', function(e) {
	    if(e.type == 'ready') { 
            ...
            Lampa.Template.add('rating_css', "\n   <style>\n .full-start__rate{padding: 0.6em 1em 1em!important;margin: 0;border-radius: 1em;font-size: .75em;margin-right: 1.5em;position: relative;}\n .full-start__rate>div:first-child{font-size: 3.2em;font-weight: 700;line-height: 1.2;}\n div{display:block;}\n .full-start__rate>div:last-child{position: absolute;bottom: -0.6em;right: 0;background-color: #fff;color: #000;padding: 0.3em;border-radius: 0.2em;font-size: .75em;}\n  </style>");
