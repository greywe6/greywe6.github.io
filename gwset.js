...
(function () {
	...
	Lampa.Listener.follow('app', function(e) {
	    if(e.type == 'ready') { 
            ...
            Lampa.Template.add('rating2_mod_css', "\n   <style>\n .info__rate{background: rgba(0,0,0,.15);border-radius: 0.3em;}\n .info__rate span{font-size: 1.45em!important;}\n </style>");
            $('body').append(Lampa.Template.get('rating2_mod_css', {}, true));
