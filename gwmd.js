...
/* ТВИКИ */
		Lampa.SettingsApi.addComponent({
			component: 'settings_modss',
			name: 'Дополнения', //Задаём название меню
		...
		Lampa.SettingsApi.addParam({
			...
			field: {
				name: 'Рамки и выделения', //Название подпункта меню
				description: 'Улучшает восприятие при выборе контента' //Комментарий к подпункту
			},
			onChange: function(value) {
				//Действия при изменении подпункта
				var green1 = '<div id="gree_style"><style>.online.focus{box-shadow: inset 0.3 0 0 0.2em #FFF!important;margin-left: -.6em!important;margin-right: -.6em!important;}</style></div>';
